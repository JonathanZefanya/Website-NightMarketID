                ...
                <div class="pb-4">
                    <div class="section shadow bg-gradient p-3 miliyan-rounded-sedang">
                        <div class="card-header ">
                            <h1>Privacy Policy for nightmarketid</h1>
                            <hr>
                            <div class="card-body ">
                                <div class="card-body">

                                    <p>At miliyan.id, accessible from https://nightmarketid.xyz, one of our main priorities
                                    ...
                                    <p>Note that nightmarketid has no access to or control over these cookies that are used
                                        by third-party advertisers.</p>

                                    <h2>Third Party Privacy Policies</h2>

                                    <p>nightmarketid's Privacy Policy does not apply to other advertisers or websites. Thus,
