                ...
                <div class="pb-4">
                    <div class="section shadow bg-gradient p-3 miliyan-rounded-sedang">
                        <div class="card-header ">
                            ...
                            <div class="card-body ">
                                <div class="card-body">
                                    <p>Welcome to nightmarketid.my.id!</p>

                                    <p>These terms and conditions outline the rules and regulations for the use of
                                        nightmarketid.my.id's Website, located at https://nightmarketid.my.id.</p>

                                    <p>By accessing this website we assume you accept these terms and conditions. Do not
                                        continue to use nightmarketid.my.id if you do not agree to take all of the terms and
                                    ...
                                    <p>We employ the use of cookies. By accessing nightmarketid.my.id, you agreed to use cookies in
                                        agreement with the nightmarketid.my.id's Privacy Policy. </p>
                                    ...
                                    <p>Unless otherwise stated, nightmarketid.my.id and/or its licensors own the intellectual
                                        property rights for all material on nightmarketid.my.id. All intellectual property rights
                                        are reserved. You may access this from nightmarketid.my.id for your own personal use
                                        subjected to restrictions set in these terms and conditions.</p>

                                    <p>You must not:</p>
                                    <ul>
                                        <li>Republish material from nightmarketid.my.id</li>
                                        <li>Sell, rent or sub-license material from nightmarketid.my.id</li>
                                        <li>Reproduce, duplicate or copy material from nightmarketid.my.id</li>
                                        <li>Redistribute content from nightmarketid.my.id</li>
                                    </ul>
                                    ...
                                    <p>Parts of this website offer an opportunity for users to post and exchange
                                        opinions and information in certain areas of the website. nightmarketid.my.id does not
                                        filter, edit, publish or review Comments prior to their presence on the website.
                                        Comments do not reflect the views and opinions of nightmarketid.my.id,its agents and/or
                                        affiliates. Comments reflect the views and opinions of the person who post their
                                        views and opinions. To the extent permitted by applicable laws, nightmarketid.my.id shall
                                    ...
                                    <p>nightmarketid.my.id reserves the right to monitor all Comments and to remove any Comments
                                    ...
                                    <p>You hereby grant nightmarketid.my.id a non-exclusive license to use, reproduce, edit and
                                    ...
                                    <p>We will approve link requests from these organizations if we decide that: (a) the
                                        ...
                                        of nightmarketid.my.id; and (d) the link is in the context of general resource information.
                                    </p>
                                    ...
                                    <p>If you are one of the organizations listed in paragraph 2 above and are
                                        ...
                                        nightmarketid.my.id. Please include your name, your organization name, contact information
                                    ...
                                    <p>No use of nightmarketid.my.id's logo or other artwork will be allowed for linking absent a
